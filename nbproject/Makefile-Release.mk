...
${OBJECTDIR}/BackToFront.o: BackToFront.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/../chord_gen -MMD -MP -MF $@.d -o ${OBJECTDIR}/BackToFront.o BackToFront.cpp

${OBJECTDIR}/Chord.o: Chord.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/../chord_gen -MMD -MP -MF $@.d -o ${OBJECTDIR}/Chord.o Chord.cpp

${OBJECTDIR}/ChordGen.o: ChordGen.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/../chord_gen -MMD -MP -MF $@.d -o ${OBJECTDIR}/ChordGen.o ChordGen.cpp

${OBJECTDIR}/ChordGenStrategy.o: ChordGenStrategy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/../chord_gen -MMD -MP -MF $@.d -o ${OBJECTDIR}/ChordGenStrategy.o ChordGenStrategy.cpp

${OBJECTDIR}/ChordSequence.o: ChordSequence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/../chord_gen -MMD -MP -MF $@.d -o ${OBJECTDIR}/ChordSequence.o ChordSequence.cpp

${OBJECTDIR}/FrontToBack.o: FrontToBack.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/../chord_gen -MMD -MP -MF $@.d -o ${OBJECTDIR}/FrontToBack.o FrontToBack.cpp

${OBJECTDIR}/RhythmGenerator.o: RhythmGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/../chord_gen -MMD -MP -MF $@.d -o ${OBJECTDIR}/RhythmGenerator.o RhythmGenerator.cpp

${OBJECTDIR}/Scale.o: Scale.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/../chord_gen -MMD -MP -MF $@.d -o ${OBJECTDIR}/Scale.o Scale.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/../chord_gen -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp
